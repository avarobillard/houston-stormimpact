...
```{r}
# This section needs a lot of help
# Explore socioeconomic geodatabase layers- not showing up for some reason
st_layers(here::here("data/ACS_2019_5YR_TRACT_48_TEXAS.gdb"))
  
ACS_tract_geometry <- st_read(here::here("data", "ACS_2019_5YR_TRACT_48.gdb"), layer = "ACS_2019_5YR_TRACT_48_TEXAS")

ACS_tract_attributes <- st_read(here::here("data", "ACS_2019_5YR_TRACT_48.gdb"), layer = "B19013e1")
  
# Ensure data sets have same coordinate reference systems 
if(crs(ACS_tract_geometry) == crs(ACS_tract_geometry)) {
  print("Coordinate reference systems match")
} else{
  warning("Updating coordinate reference systems to match")
  # transform data to match
  boundary <- st_transform(ACS_tract_geometry, st_crs(ACS_tract_geometry))
}
```
...
levels(light_diff_rcl) <- tibble::tibble(id = 0:2, 
