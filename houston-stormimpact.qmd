...
bb <- st_bbox(c(xmin = -94.5, xmax = -96.5, ymax = 30.5, ymin = 29.0), crs = st_crs(lights_2021_02_07))
lights_2021_02_07 <- st_crop(lights_2021_02_07, bb)

lights_2021_02_16 <- st_crop(lights_2021_02_16, bb)

# ST_CROP HERE & breaks in tm_raster(palette= , change breaks)
...
#bb <- st_bbox(c(xmin = -94.5, xmax = -96.5, ymax = 30.5, ymin = 29.0), crs = st_crs(3083))
#light_diff_houston <- st_crop(light_diff_houston, bb)
...
highway_union <- st_union(roads) 

# Create 200m buffer around all highways
highway_buffer <- st_buffer(highway_union, dist = 200)
...
# Transform CRS
light_diff_vec <- st_transform(light_diff_vec, 3083)

true_blackouts <- st_difference(light_diff_vec, highway_buffer)
