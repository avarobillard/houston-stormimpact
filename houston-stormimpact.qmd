...
# Check for same extent and resolution first! make into WARNING MESSAGE
...
# Check for valid geometry- make into WARNING MESSAGE
print(any(!st_is_valid(light_diff_vec)))
```
